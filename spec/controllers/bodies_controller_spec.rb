...
describe BodiesController do
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested body" do
        ...
        put :update, :id => body.id, :body => {'these' => 'params'}
      end

      it "assigns the requested body as @body" do
        body = Body.create! valid_attributes
        put :update, :id => body.id, :body => valid_attributes
        assigns(:body).should eq(body)
      end
    ...
    describe "with invalid params" do
      it "assigns the body as @body" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Body.any_instance.stub(:save).and_return(false)
        put :update, :id => body.id.to_s, :body => {}
        assigns(:body).should eq(body)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested body" do
      body = Body.create! valid_attributes
      expect {
        delete :destroy, :id => body.id.to_s
      }.to change(Body, :count).by(-1)
    end
